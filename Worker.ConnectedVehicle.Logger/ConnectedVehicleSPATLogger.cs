...
public class ConnectedVehicleSPATLogger : BackgroundService
{
    ...
    )
    {
        ...
        _loopCounter = metricsFactory.GetMetricsCounter("Logger SPAT");
    }
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                JsonDocument status => _logService.ProcessMessageAsync(status, ConnectedVehicleMessageTypeEnum.SPAT),
