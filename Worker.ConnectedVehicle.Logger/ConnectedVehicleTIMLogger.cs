...
public class ConnectedVehicleTIMLogger : BackgroundService
{
    ...
    )
    {
        ...
        _loopCounter = metricsFactory.GetMetricsCounter("Logger TIM");
    }
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                JsonDocument status => _logService.ProcessMessageAsync(status, ConnectedVehicleMessageTypeEnum.TIM),
