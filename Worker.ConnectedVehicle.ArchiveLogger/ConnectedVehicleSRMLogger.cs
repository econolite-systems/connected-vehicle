...
public class ConnectedVehicleSRMLogger : BackgroundService
{
    ...
    )
    {
        ...
        _loopCounter = metricsFactory.GetMetricsCounter("Archive Logger SRM");
    }
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                JsonDocument status => _archiveService.ProcessMessageAsync(status, ConnectedVehicleMessageTypeEnum.SRM),
