...
await AppBuilder.BuildAndRunWebHostAsync(args, options => { options.Source = "Connected Vehicle Archive Logger"; }, (builder, services) =>
{
    services.AddMongo();
    services.AddConnectedVehicleArchiveLoggerWorker();
